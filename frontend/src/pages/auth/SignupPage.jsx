                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-[2rem] shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button 
                            disabled={loading}
                            type="submit"
                            className="w-full bg-black hover:bg-slate-800 text-white font-bold py-4 rounded-xl shadow-lg shadow-black/20 transition-all flex items-center justify-center gap-2 group mt-4"
                        >
