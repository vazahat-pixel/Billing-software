...
export const THEMES = {
  ...
  classic: {
    ...
    tokens: toCssVars({
      ...
      'radius-card': '4px',
      'radius-input': '3px',
      /* Richer WinForms / JSM-style — less washed-out beige */
      'bg-base': '#b9b5a8',
      'bg-sidebar': '#ddd8c8',
      'bg-card': '#ece8d8',
      'bg-card-hover': '#f5f1e4',
      'bg-subtle': '#cfcab8',
      'bg-elevated': '#ffffff',
      'border-subtle': '#9a9588',
      border: '#6e6a60',
      'border-strong': '#3d3a34',
      'text-primary': '#141210',
      'text-secondary': '#2c2924',
      'text-muted': '#5c574e',
      'color-primary': '#0050c8',
      'color-primary-hover': '#003d9a',
      'color-primary-light': '#d6e4ff',
      'color-secondary': '#3d3a34',
      'color-success': '#0a7a0a',
      'color-success-bg': '#d8f0d8',
      'color-warning': '#9a7b00',
      'color-warning-bg': '#fff3bf',
      'color-danger': '#b00020',
      'color-danger-bg': '#ffd6d6',
      'color-info': '#007a7a',
      'color-info-bg': '#d0f5f5',
      accent: '#0055ea',
      'accent-hover': '#0040b8',
      'accent-light': '#d6e4ff',
      'accent-gradient': 'linear-gradient(180deg, #2b6cdf 0%, #0055ea 55%, #003d9a 100%)',
      green: '#0a7a0a',
      'green-bg': '#d8f0d8',
      amber: '#9a7b00',
      'amber-bg': '#fff3bf',
      ...
      blue: '#0055ea',
      'blue-bg': '#d6e4ff',
      'shadow-sm': 'inset 1px 1px 0 #fff, 1px 1px 0 #6e6a60',
      'shadow-md': '2px 2px 0 #3d3a34',
      'shadow-lg': '3px 3px 0 #3d3a34',
      'shadow-float': '4px 4px 0 #3d3a34',
      'shadow-glow': 'none',
      'focus-ring': '1px dotted #141210',
    }),
  },
  'high-contrast': {
    id: 'high-contrast',
