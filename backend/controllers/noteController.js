...
exports.updateNote = async (req, res) => {
  ...
  try {
    ...
    // Must run BEFORE any field validation: an auto note is owned by its source voucher,
    // so the operator needs to be sent there rather than told which field is missing.
