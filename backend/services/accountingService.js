...
const SYSTEM_LEDGER_TEMPLATES = [
  ...
  { name: 'TDS ACCOUNT', group: 'Liabilities', subGroup: 'Current Liabilities' },
  { name: 'TDS ON JOBWORK', group: 'Liabilities', subGroup: 'Current Liabilities' },
  { name: 'TDS ON PROCESS', group: 'Liabilities', subGroup: 'Current Liabilities' },
  { name: 'DISCOUNT ACCOUNT', group: 'Expenses', subGroup: 'Indirect Expenses' },
